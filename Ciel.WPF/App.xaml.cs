...
using Ciel.WPF.Core.Services;
using Ciel.WPF.Core.Services.API;
using Ciel.WPF.Models;
using Ciel.WPF.Services;
using Ciel.WPF.ViewModels;
using Ciel.WPF.Views;
...
public partial class App : Application
{
    ...
    private void ConfigureServices(HostBuilderContext context, IServiceCollection services)
    {
        ...
        services.AddHttpClient("ciel", client =>
        {
        ...
        // Core Services
        services.AddSingleton<IAPIIdentityService, APIIdentityService>();
